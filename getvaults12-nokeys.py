...
web3_infura = Web3(Web3.HTTPProvider('https://mainnet.infura.io/v3/f'))
web_url = 'www.onlyowner.trade'
ssh_key = 'notblah'
...
comp0x = '0xc00e94Cb662C3520282E6f5717214004A7f26888'
lrc0x = '0xBBbbCA6A901c926F240b89EacB641d8Aec7AEafD'
link0x = '0x514910771AF9Ca656af840dff83E8264EcF986CA'
busd0x = '0x4Fabb145d64652a948d72533023f6E7A623C7C53'




ydai0x = '0x16de59092dAE5CcF4A1E6439D611fd0653f0Bd01'
...
adaiabi = json.loads('[{"inputs":[{"internalType":"contract LendingPoolAddressesProvider","name":"_addressesProvider","type":"address"},{"internalType":"address","name":"_underlyingAsset","type":"address"},{"internalType":"uint8","name":"_underlyingAssetDecimals","type":"uint8"},{"internalType":"string","name":"_name","type":"string"},{"internalType":"string","name":"_symbol","type":"string"}],"payable":false,"stateMutability":"nonpayable","type":"constructor"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"owner","type":"address"},{"indexed":true,"internalType":"address","name":"spender","type":"address"},{"indexed":false,"internalType":"uint256","name":"value","type":"uint256"}],"name":"Approval","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_from","type":"address"},{"indexed":true,"internalType":"address","name":"_to","type":"address"},{"indexed":false,"internalType":"uint256","name":"_value","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromBalanceIncrease","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_toBalanceIncrease","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromIndex","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_toIndex","type":"uint256"}],"name":"BalanceTransfer","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_from","type":"address"},{"indexed":false,"internalType":"uint256","name":"_value","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromBalanceIncrease","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromIndex","type":"uint256"}],"name":"BurnOnLiquidation","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_from","type":"address"},{"indexed":true,"internalType":"address","name":"_to","type":"address"}],"name":"InterestRedirectionAllowanceChanged","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_from","type":"address"},{"indexed":true,"internalType":"address","name":"_to","type":"address"},{"indexed":false,"internalType":"uint256","name":"_redirectedBalance","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromBalanceIncrease","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromIndex","type":"uint256"}],"name":"InterestStreamRedirected","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_from","type":"address"},{"indexed":false,"internalType":"uint256","name":"_value","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromBalanceIncrease","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromIndex","type":"uint256"}],"name":"MintOnDeposit","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_from","type":"address"},{"indexed":false,"internalType":"uint256","name":"_value","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromBalanceIncrease","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_fromIndex","type":"uint256"}],"name":"Redeem","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"_targetAddress","type":"address"},{"indexed":false,"internalType":"uint256","name":"_targetBalanceIncrease","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_targetIndex","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_redirectedBalanceAdded","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"_redirectedBalanceRemoved","type":"uint256"}],"name":"RedirectedBalanceUpdated","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"from","type":"address"},{"indexed":true,"internalType":"address","name":"to","type":"address"},{"indexed":false,"internalType":"uint256","name":"value","type":"uint256"}],"name":"Transfer","type":"event"},{"constant":true,"inputs":[],"name":"UINT_MAX_VALUE","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"_to","type":"address"}],"name":"allowInterestRedirectionTo","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"internalType":"address","name":"owner","type":"address"},{"internalType":"address","name":"spender","type":"address"}],"name":"allowance","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"spender","type":"address"},{"internalType":"uint256","name":"value","type":"uint256"}],"name":"approve","outputs":[{"internalType":"bool","name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"balanceOf","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"_account","type":"address"},{"internalType":"uint256","name":"_value","type":"uint256"}],"name":"burnOnLiquidation","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"decimals","outputs":[{"internalType":"uint8","name":"","type":"uint8"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"spender","type":"address"},{"internalType":"uint256","name":"subtractedValue","type":"uint256"}],"name":"decreaseAllowance","outputs":[{"internalType":"bool","name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"getInterestRedirectionAddress","outputs":[{"internalType":"address","name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"getRedirectedBalance","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"getUserIndex","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"spender","type":"address"},{"internalType":"uint256","name":"addedValue","type":"uint256"}],"name":"increaseAllowance","outputs":[{"internalType":"bool","name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"internalType":"address","name":"_user","type":"address"},{"internalType":"uint256","name":"_amount","type":"uint256"}],"name":"isTransferAllowed","outputs":[{"internalType":"bool","name":"","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"_account","type":"address"},{"internalType":"uint256","name":"_amount","type":"uint256"}],"name":"mintOnDeposit","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"name","outputs":[{"internalType":"string","name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"internalType":"address","name":"_user","type":"address"}],"name":"principalBalanceOf","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"internalType":"uint256","name":"_amount","type":"uint256"}],"name":"redeem","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"_to","type":"address"}],"name":"redirectInterestStream","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"_from","type":"address"},{"internalType":"address","name":"_to","type":"address"}],"name":"redirectInterestStreamOf","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"symbol","outputs":[{"internalType":"string","name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"totalSupply","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"recipient","type":"address"},{"internalType":"uint256","name":"amount","type":"uint256"}],"name":"transfer","outputs":[{"internalType":"bool","name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"sender","type":"address"},{"internalType":"address","name":"recipient","type":"address"},{"internalType":"uint256","name":"amount","type":"uint256"}],"name":"transferFrom","outputs":[{"internalType":"bool","name":"","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"address","name":"_from","type":"address"},{"internalType":"address","name":"_to","type":"address"},{"internalType":"uint256","name":"_value","type":"uint256"}],"name":"transferOnLiquidation","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"underlyingAssetAddress","outputs":[{"internalType":"address","name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"}]')
...
#go to the ilk registry 0x8b4ce5DCbb01e0e1f0521cd8dCfb31B308E52c24 to get illks
...
COMP_A_ILK = '0x434f4d502d410000000000000000000000000000000000000000000000000000'
LRC_A_ILK = '0x4c52432d41000000000000000000000000000000000000000000000000000000'
LINK_A_ILK = '0x4c494e4b2d410000000000000000000000000000000000000000000000000000'
...
#VAULTS_I_CARE_ABOUT_CSV = 'testcasevaults.csv'
FILES_I_CARE_ABOUT_CSV = 'filesIcareabout.csv'
PREV_BLOCK_UPDATED_CSV = 'prevblockupdated.csv'
...
AMMS = {'0xA478c2975Ab1Ea89e8196811F51A7B7Ade33eB11':'Uniswap ETH/DAI',
	...
	'0x2E703D658f8dd21709a7B458967aB4081F8D3d05':'Shell Finance'
...
class Owner():
	def __init__(self):
		...
		self.total_vault_debt = 0
		self.farming_utilization = 0

		self.wallet_dai = 0
		self.cdai_supplied = 0
		self.cdai_borrowed = 0
		self.adai_supplied = 0
		self.adai_borrowed = 0
		
		self.total_curve_farming = 0
		self.total_dai_curve_farming = 0
		self.yswusd_y_usd = 0
		self.dai_swerve_y = 0

		self.dai_uni_farming = 0
		self.ydai_vault_deposits = 0
		self.dai_sushi_farming = 0
		self.dai_mooniswap_daiusdc = 0
		self.dai_harvest_finance_ethdai_uniswap_lp = 0
		self.dai_harvest_finance_dai_staked = 0
...
class Strat():
	def __init__(self):
		...
		self.ycrv_y_usd = 0
		self.dai_y = 0
		self.ycrv_comp_usd = 0
		self.dai_comp_curve = 0
		self.ycrv_susd_usd = 0
		self.dai_susd = 0
		self.ycrv_3_usd = 0
		self.dai_3 = 0
		self.ycrv_busd_usd = 0
		self.dai_busd = 0
		self.ycrv_pax_usd = 0
		self.dai_pax = 0
		self.ycrv_usdt_usd = 0
		self.dai_usdt = 0
		self.total_curve_farming = 0
		self.total_dai_curve_farming = 0
		self.yswusd_y_usd = 0
	...
	def check_brrr(self):
		if((self.ilk_type == 'USDCA') or (self.ilk_type == 'TUSDA') or (self.ilk_type == 'PAXA')):
			if(self.current_ratio <= 1.01):
				self.strategy.append(['BRRRRRRR', self.current_debt])
	...
	def check_list(self):
		...
		# for i in unilplist:
		# 	bal = 0
		# 	bal, nam = getunilptokenbalance(self.actual_owner, i, dai0x)
		# 	if(bal > dust_threshold):
		# 		self.strategy.append([nam, bal])

		# check special case of uni farming
		unirewards_contract = web3.eth.contract(address=ethdaiuniswapstaking0x, abi=ethdaiunilpabi)
		unilp_contract = web3.eth.contract(address=ethdaiuniswap0x, abi=ethdaiunilpabi)
		dai_contract = web3.eth.contract(address=dai0x, abi=ethdaiunilpabi)
		bal = 0
		bal = unirewards_contract.functions.balanceOf(self.actual_owner).call() / ETH_SCALE
		percent_supply = 0
		percent_supply = (bal * ETH_SCALE) / unilp_contract.functions.totalSupply().call()
		dai_supplied = (percent_supply * dai_contract.functions.balanceOf(ethdaiuniswap0x).call()) / ETH_SCALE
		if(dai_supplied > dust_threshold):
			self.dai_uni_farming = dai_supplied

		# # check balancer lp tokens
		# for i in balancerlplist:
		# 	bal = 0
		# 	bal, nam = getbalancerlptokenbalance(self.actual_owner, i, dai0x)
		# 	if(bal > dust_threshold):
		# 		self.strategy.append([nam, bal])
		...
		usdt_contract = web3.eth.contract(address=usdt0x, abi=ethdaiunilpabi)
		# tusd_contract = web3.eth.contract(address=tusd0x, abi=ethdaiunilpabi)
		# usdc_contract = web3.eth.contract(address=usdc0x, abi=ethdaiunilpabi)
		# busd_contract = web3.eth.contract(address=busd0x, abi=ethdaiunilpabi)
		# pax_contract = web3.eth.contract(address=pax0x, abi=ethdaiunilpabi)

		#check comp pool manually 
		...
		if(bal > dust_threshold):
			virtual_price = 1.04
			self.ycrv_comp_usd = bal * virtual_price
			dai_in_pool, nam = getctokenbalance('0xA2B47E3D5c44877cca798226B7B8118F9BFb7A56', cdai0x)
			usdc_in_pool, nam = getctokenbalance('0xA2B47E3D5c44877cca798226B7B8118F9BFb7A56', cusdc0x)
			portion_dai = dai_in_pool / (usdc_in_pool + dai_in_pool)
			self.dai_comp_curve = bal * portion_dai

		#check usdt pool manually 
		gauge_comp_contract = web3.eth.contract(address='0xBC89cd85491d81C6AD2954E6d0362Ee29fCa8F53', abi=ethdaiunilpabi)
		bal = 0
		bal = gauge_comp_contract.functions.balanceOf(self.actual_owner).call() / ETH_SCALE
		if(bal > dust_threshold):
			curve_usdt_contract = web3.eth.contract(address='0x52EA46506B9CC5Ef470C5bf89f17Dc28bB35D85C', abi=curveyabi)
			vprice = curve_usdt_contract.functions.get_virtual_price().call() / ETH_SCALE
			self.ycrv_usdt_usd = bal * vprice
			dai_in_pool, nam = getctokenbalance('0x52EA46506B9CC5Ef470C5bf89f17Dc28bB35D85C', cdai0x)
			usdc_in_pool, nam = getctokenbalance('0x52EA46506B9CC5Ef470C5bf89f17Dc28bB35D85C', cusdc0x)
			usdt_in_pool = usdt_contract.functions.balanceOf('0x52EA46506B9CC5Ef470C5bf89f17Dc28bB35D85C').call() / USDC_SCALE
			portion_dai = dai_in_pool / (usdc_in_pool + dai_in_pool + usdt_in_pool)
			self.dai_usdt = bal * portion_dai

		# y pool                                                  gauge,        ytoken contract,    swap
		usdfarming, daifarming = getcurvestuff(self.actual_owner, '0xFA712EE4788C042e2B7BB55E6cb8ec569C4530c1', '0xdF5e0e81Dff6FAF3A7e52BA697820c5e32D806A8', '0x45F783CCE6B7FF23B2ab2D70e416cdb7D6055f51')
		self.ycrv_y_usd = usdfarming
		self.dai_y = daifarming
		# busd pool
		usdfarming, daifarming = getcurvestuff(self.actual_owner, '0x69Fb7c45726cfE2baDeE8317005d3F94bE838840', '0x3B3Ac5386837Dc563660FB6a0937DFAa5924333B', '0x79a8C46DeA5aDa233ABaFFD40F3A0A2B1e5A4F27')
		self.ycrv_busd_usd = usdfarming
		self.dai_busd = daifarming
		# pax pool
		usdfarming, daifarming = getcurvestuff(self.actual_owner, '0x64E3C23bfc40722d3B649844055F1D51c1ac041d', '0xD905e2eaeBe188fc92179b6350807D8bd91Db0D8', '0x06364f10B501e868329afBc005b3492902d6C763')
		self.ycrv_pax_usd = usdfarming
		self.dai_pax = daifarming
		# 3 pool
		usdfarming, daifarming = getcurvestuff(self.actual_owner, '0xbFcF63294aD7105dEa65aA58F8AE5BE2D9d0952A', '0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490', '0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7')
		self.ycrv_3_usd = usdfarming
		self.dai_3 = daifarming
		# susd v2 pool
		usdfarming, daifarming = getcurvestuff(self.actual_owner, '0xDCB6A51eA3CA5d3Fd898Fd6564757c7aAeC3ca92', '0xC25a3A3b969415c80451098fa907EC722572917F', '0xA5407eAE9Ba41422680e2e00537571bcC53efBfD')
		self.ycrv_susd_usd = usdfarming
		self.dai_susd = daifarming
		# add up all curve deposits
		self.total_curve_farming = self.ycrv_comp_usd + self.ycrv_usdt_usd + self.ycrv_y_usd + self.ycrv_busd_usd + self.ycrv_pax_usd + self.ycrv_3_usd + self.ycrv_susd_usd
		self.total_dai_curve_farming = self.dai_comp_curve + self.dai_usdt + self.dai_y + self.dai_busd + self.dai_pax + self.dai_3 + self.dai_susd

		#check swerve y
		gauge_swerve_contract = web3.eth.contract(address='0xb4d0C929cD3A1FbDc6d57E7D3315cF0C4d6B4bFa', abi=ethdaiunilpabi)
		bal = 0
		bal = gauge_swerve_contract.functions.balanceOf(self.actual_owner).call() / ETH_SCALE
		if(bal > dust_threshold):
			ydai_contract = web3.eth.contract(address='0x77C6E4a580c0dCE4E5c7a17d0bc077188a83A059', abi=ethdaiunilpabi)
			totalyDai = ydai_contract.functions.totalSupply().call()
			percent_yDai = (bal * ETH_SCALE) / totalyDai

			curve_y_contract = web3.eth.contract(address='0x329239599afB305DA0A2eC69c58F8a6697F9F88d', abi=curveyabi)
			vprice_swerve = 1.04
			self.yswusd_y_usd = bal * vprice_swerve
			# balance of total dai in pool
			dai_in_pool = curve_y_contract.functions.balances(0).call()
			self.dai_swerve_y = (dai_in_pool * percent_yDai) / ETH_SCALE

		#check sushiswap
		sushi_rewards_contract = web3.eth.contract(address='0xc2EdaD668740f1aA35E4D8f227fB8E17dcA888Cd', abi=sushimasterchefabi)
		sushi_ethdai = web3.eth.contract(address='0xC3D03e4F041Fd4cD388c549Ee2A29a9E5075882f', abi=ethdaiunilpabi)
		bal = 0
		#eth/dai pool
		pool_id = 2
		iss = sushi_rewards_contract.functions.userInfo(pool_id, web3.toChecksumAddress(self.actual_owner)).call()
		bal = iss[0]
		percent_balance = bal / sushi_ethdai.functions.totalSupply().call()
		bal = (percent_balance * dai_contract.functions.balanceOf('0xC3D03e4F041Fd4cD388c549Ee2A29a9E5075882f').call()) / ETH_SCALE
		if(bal > dust_threshold):
			self.dai_sushi_farming = bal

		#check owner cDai supply and borrow
		cdai_contract = web3.eth.contract(address=cdai0x, abi=cdaiabi)
		cdai_supply = cdai_contract.functions.balanceOfUnderlying(self.actual_owner).call() / ETH_SCALE
		cdai_borrow = cdai_contract.functions.borrowBalanceStored(self.actual_owner).call() / ETH_SCALE
		if(cdai_supply > dust_threshold):
			self.cdai_supplied = cdai_supply
		if(cdai_borrow > dust_threshold):
			self.cdai_borrowed = cdai_borrow

		#check owner aDai supply and borrow
		#adai_contract = web3.eth.contract(address=adai0x, adaiabi)
		aave_lending_pool_contract = web3.eth.contract(address='0x398eC7346DcD622eDc5ae82352F02bE94C62d119', abi=aavelendingpoolabi)
		user_reserve_data = aave_lending_pool_contract.functions.getUserReserveData(dai0x, self.actual_owner).call()
		adai_supply = user_reserve_data[0] / ETH_SCALE
		adai_borrow = user_reserve_data[1] / ETH_SCALE
		if(adai_supply > dust_threshold):
			self.adai_supplied = adai_supply
		if(adai_borrow > dust_threshold):
			self.adai_borrowed = adai_borrow

		# check wallet dai
		wallet_d = dai_contract.functions.balanceOf(self.actual_owner).call() / ETH_SCALE
		if(wallet_d > dust_threshold):
			self.wallet_dai = wallet_d

		#check yDai
		ydai_contract = web3.eth.contract(address=ydai0x, abi=ydaiabi)
		vprice = ydai_contract.functions.getPricePerFullShare().call() / ETH_SCALE
		ydai_balance = ydai_contract.functions.balanceOf(self.actual_owner).call() / ETH_SCALE
		if(ydai_balance > dust_threshold):
			self.ydai_vault_deposits = ydai_balance * vprice

		#check mooniswap
		mooni_contract = web3.eth.contract(address='0x31631b3DD6C697E574d6B886708cd44f5ccf258F', abi=ethdaiunilpabi)
		ts = mooni_contract.functions.totalSupply().call()
		sup = mooni_contract.functions.balanceOf(self.actual_owner).call()
		percent_supply = sup / ts
		if(sup > dust_threshold):
			dbal = dai_contract.functions.balanceOf('0x31631b3DD6C697E574d6B886708cd44f5ccf258F').call() / ETH_SCALE
			self.dai_mooniswap_daiusdc = dbal * percent_supply

		#check harvest.finance dai-eth uni lps
		farm1_contract = web3.eth.contract(address='0x7aeb36e22e60397098C2a5C51f0A5fB06e7b859c', abi=ethdaiunilpabi)
		# check the real eth-dai uni pool total supply
		unilp_contract = web3.eth.contract(address=ethdaiuniswap0x, abi=ethdaiunilpabi)
		ts = unilp_contract.functions.totalSupply().call()
		sup = farm1_contract.functions.balanceOf(self.actual_owner).call()
		percent_supply = sup / ts
		if(sup > dust_threshold):
			dbal = dai_contract.functions.balanceOf(ethdaiuniswap0x).call() / ETH_SCALE
			self.dai_harvest_finance_ethdai_uniswap_lp = dbal * percent_supply

		#check harvest.finance dai stakers
		farm2_contract = web3.eth.contract(address='0xe85C8581e60D7Cd32Bbfd86303d2A4FA6a951Dac', abi=harvestdaiabi)
		sup = farm2_contract.functions.contributions(self.actual_owner).call() / ETH_SCALE
		if(sup > dust_threshold):
			self.dai_harvest_finance_dai_staked = sup
...
def getcurvestuff(own, gauge0x, ytoken0x, curveswap0x ):

	gauge_y_contract = web3.eth.contract(address=gauge0x, abi=ethdaiunilpabi)
	bal = 0
	usd_farming = 0
	dai_farming = 0
	dust_threshold = 0.001
	bal = gauge_y_contract.functions.balanceOf(own).call() / ETH_SCALE
	if(bal > dust_threshold):
		ydai_contract = web3.eth.contract(address=ytoken0x, abi=ethdaiunilpabi)
		totalyDai = ydai_contract.functions.totalSupply().call()
		percent_yDai = (bal * ETH_SCALE) / totalyDai

		curve_y_contract = web3.eth.contract(address=curveswap0x, abi=curveyabi)
		vprice = curve_y_contract.functions.get_virtual_price().call() / ETH_SCALE
		usd_farming = bal * vprice
		# had to do this on 3 pool for some reason
		if(curveswap0x == '0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7'):
			dai_c = web3.eth.contract(address=dai0x, abi=ethdaiunilpabi)
			dai_in_pool = dai_c.functions.balanceOf(curveswap0x).call()
		else:
			# balance of total dai in pool
			dai_in_pool = curve_y_contract.functions.balances(0).call()
		dai_farming = (dai_in_pool * percent_yDai) / ETH_SCALE

	return usd_farming, dai_farming
...
def getbalancerlptokenbalance(own, balancerlptoke, tokenx):
	ballp_contract = web3.eth.contract(address=balancerlptoke, abi=balancerpoolabi)
	tokenx_contract = web3.eth.contract(address=tokenx, abi=ethdaiunilpabi)
	balan = ballp_contract.functions.balanceOf(own).call()
	percent_balan = balan / ballp_contract.functions.totalSupply().call()
	balan = (percent_balan * tokenx_contract.functions.balanceOf(balancerlptoke).call()) / ETH_SCALE
	name = AMMS[balancerlptoke]
	return balan, name

def getunilptokenbalance(own, unilptoke, tokenx):
	unilp_contract = web3.eth.contract(address=unilptoke, abi=ethdaiunilpabi)
	tokenx_contract = web3.eth.contract(address=tokenx, abi=ethdaiunilpabi)
	
	balan = unilp_contract.functions.balanceOf(own).call()
	percent_balan = balan /  unilp_contract.functions.totalSupply().call()
	balan = (percent_balan * tokenx_contract.functions.balanceOf(unilptoke).call()) / ETH_SCALE
	name = AMMS[unilptoke]
	return balan, name
...
def meat_and_potato(vaults, urn_to_id_dict, lid_v0_to_id_dict, lid_v1_to_id_dict, lid_v2_to_id_dict, latest_update_block, block_to_go_to, write_objs, step_siz):
	...
	#the end of the giant for loop
	# save the latest block updated
	with open(PREV_BLOCK_UPDATED_CSV, 'w') as myfile1:
		wr = csv.writer(myfile1)
		wr.writerow([block_to_go_to])
...
def get_ilk_prices():
	...
	comp = web3.eth.contract(address=comp0x, abi=ethdaiunilpabi)
	lrc = web3.eth.contract(address=lrc0x, abi=ethdaiunilpabi)
	link = web3.eth.contract(address=link0x, abi=ethdaiunilpabi)
	...
	comp_bal = comp.functions.balanceOf('0xCFfDdeD873554F362Ac02f8Fb1f02E5ada10516f').call() / ETH_SCALE
	weth_bal = weth.functions.balanceOf('0xCFfDdeD873554F362Ac02f8Fb1f02E5ada10516f').call() / ETH_SCALE
	competh_price = weth_bal / comp_bal
	ilk_prices['COMPA'] = competh_price * ethusd_price

	lrc_bal = lrc.functions.balanceOf('0x8878Df9E1A7c87dcBf6d3999D997f262C05D8C70').call() / ETH_SCALE
	weth_bal = weth.functions.balanceOf('0x8878Df9E1A7c87dcBf6d3999D997f262C05D8C70').call() / ETH_SCALE
	lrceth_price = weth_bal / lrc_bal
	ilk_prices['LRCA'] = lrceth_price * ethusd_price

	link_bal = link.functions.balanceOf('0xa2107FA5B38d9bbd2C461D6EDf11B11A50F6b974').call() / ETH_SCALE
	weth_bal = weth.functions.balanceOf('0xa2107FA5B38d9bbd2C461D6EDf11B11A50F6b974').call() / ETH_SCALE
	linketh_price = weth_bal / link_bal
	ilk_prices['LINKA'] = linketh_price * ethusd_price	
...
def output_farming_csv_old(strat_file):
	vaults = get_pickle(VAULT_OBJ_FILENAME)
	...
	for i in strats:
		...
		for k in i.strategy:
			strat_string = k[0]
			strat_num = k[1]
			strat_list.append(strat_string)
			strat_list.append(strat_num)
		roww = []
		roww.append(i.vaultid)
		roww.append(i.ilk_type)
		roww.append(i.actual_owner)
		roww.append("{0:.2f}".format(i.current_debt))
		roww.append("{0:.5f}".format(i.current_ratio))
		for p in strat_list:
			roww.append(p)
		list_vaults.append(roww)
	sorted_interactions = sorted(list_vaults, key=lambda x: x[0])
	with open(FARMING_CSV_FILENAME, 'w') as myfile2:
		wr = csv.writer(myfile2)
		wr.writerow(["vaultid", "ilk", "owner", "debt", "ratio", "activity", "DAI in contract"],)
		for i in range(0, len(sorted_interactions)):
			...
			wr.writerow(sorted_interactions[i])
...
def output_farming_csv_new(strat_file, newfil):
	vaults = get_pickle(VAULT_OBJ_FILENAME)
	strats = get_pickle(strat_file)
	urn_to_id_dict = get_pickle(URN_TO_ID_DICT_FILENAME)
	actual_owners = get_pickle(ACTUAL_OWNERS_OBJ_FILENAME)
	...
	unique_owners = []
	for i in strats:
		if(i.actual_owner not in unique_owners):
			unique_owners.append(i.actual_owner)
	for i in unique_owners:
		ownn = Owner()
		ownn.address = i
		for k in strats:
			if(i == k.actual_owner):
				if(k.ilk_type == 'ETHA'):
					ownn.ethadebt += k.current_debt
				elif(k.ilk_type == 'BATA'):
					ownn.batadebt += k.current_debt
				elif(k.ilk_type == 'WBTCA'):
					ownn.wbtcadebt += k.current_debt
				elif(k.ilk_type == 'USDCA'):
					ownn.usdcadebt += k.current_debt
				elif(k.ilk_type == 'USDCB'):
					ownn.usdcbdebt += k.current_debt
				elif(k.ilk_type == 'USDTA'):
					ownn.usdtadebt += k.current_debt
				elif(k.ilk_type == 'TUSDA'):
					ownn.tusdadebt += k.current_debt
				elif(k.ilk_type == 'PAXA'):
					ownn.paxadebt += k.current_debt
				elif(k.ilk_type == 'MANAA'):
					ownn.manaadebt += k.current_debt
				elif(k.ilk_type == 'ZRXA'):
					ownn.zrxadebt += k.current_debt
				elif(k.ilk_type == 'LRCA'):
					ownn.lrcadebt += k.current_debt
				elif(k.ilk_type == 'COMPA'):
					ownn.compadebt += k.current_debt
				elif(k.ilk_type == 'LINKA'):
					ownn.linkadebt += k.current_debt
				elif(k.ilk_type == 'KNCA'):
					ownn.kncadebt += k.current_debt

				ownn.total_vault_debt += k.current_debt

				ownn.wallet_dai = k.wallet_dai
				ownn.cdai_supplied = k.cdai_supplied
				ownn.cdai_borrowed = k.cdai_borrowed
				ownn.adai_supplied = k.adai_supplied
				ownn.adai_borrowed = k.adai_borrowed
				ownn.total_curve_farming = k.total_curve_farming
				ownn.total_dai_curve_farming = k.total_dai_curve_farming
				ownn.yswusd_y_usd = k.yswusd_y_usd
				ownn.dai_swerve_y = k.dai_swerve_y

				ownn.dai_uni_farming = k.dai_uni_farming
				ownn.ydai_vault_deposits = k.ydai_vault_deposits
				ownn.dai_sushi_farming = k.dai_sushi_farming
				ownn.dai_mooniswap_daiusdc = k.dai_mooniswap_daiusdc
				ownn.dai_harvest_finance_dai_staked = k.dai_harvest_finance_dai_staked
				ownn.dai_harvest_finance_ethdai_uniswap_lp = k.dai_harvest_finance_ethdai_uniswap_lp
		
				ownn.total_dai_farming = ownn.cdai_supplied - ownn.cdai_borrowed + ownn.adai_supplied - ownn.adai_borrowed + ownn.total_curve_farming + ownn.yswusd_y_usd + ownn.dai_uni_farming + ownn.ydai_vault_deposits + ownn.dai_sushi_farming + ownn.dai_mooniswap_daiusdc + ownn.dai_harvest_finance_dai_staked + ownn.dai_harvest_finance_ethdai_uniswap_lp 
				if((ownn.total_vault_debt != 0) and (ownn.total_dai_farming > 0)):
					ownn.farming_utilization = ownn.total_dai_farming / ownn.total_vault_debt
		owners.append(ownn)

	for i in owners:
		roww = [i.address, i.ethadebt, i.batadebt, i.usdcadebt, i.usdcbdebt, i.wbtcadebt, i.tusdadebt, i.usdtadebt, i.paxadebt, i.manaadebt, i.zrxadebt, i.lrcadebt, i.compadebt, i.linkadebt, i.kncadebt, i.total_vault_debt, i.wallet_dai, i.cdai_supplied, i.cdai_borrowed, i.adai_supplied, i.adai_borrowed, i.total_curve_farming, i.total_dai_curve_farming, i.yswusd_y_usd, i.dai_swerve_y, i.dai_uni_farming, i.ydai_vault_deposits, i.dai_sushi_farming, i.dai_mooniswap_daiusdc, i.dai_harvest_finance_dai_staked, i.dai_harvest_finance_ethdai_uniswap_lp, i.farming_utilization]
		list_owners.append(roww)
	with open(newfil, 'w') as myfile2:
		wr = csv.writer(myfile2)
		wr.writerow(["owner", "ethAdebt", "batAdebt", "usdcAdebt", "usdcBdebt", "wbtcAdebt", "tusdAdebt", "usdtAdebt", "paxAdebt", "manaAdebt", "zrxAdebt", "lrcAdebt", "compAdebt", "linkAdebt", "kncAdebt", "totalVaultDebt", "walletDai", "cDaiSupplied", "cDaiBorrowed", "aDaiSupplied", "aDaiBorrowed", "totalVirtualUSDFarmingCurve", "totalDaiFarmingCurve", "virtualUSDFarmingSwerve", "DaiFarmingSwerve", "DaiFarmingUNI", "yDai", "DaiFarmingSushi", "DaiMooniswapDAIUSDC", "HarvestFinanceDAI", "HarvestFinanceETHDAIUNILP", "farmingDebtUtilization"],)
...
def get_files_i_care_about():
	vvs = []
	with open(FILES_I_CARE_ABOUT_CSV, 'r') as myfile44:
		rr = csv.reader(myfile44)
		for row in rr:
			vvs.append(str(row[0]))
	return vvs

def get_prev_b():
	bbb = 0
	with open(PREV_BLOCK_UPDATED_CSV, 'r') as myfile3:
		rr = csv.reader(myfile3)
		for row in rr:
			bbb = int(row[0])
	return bbb

def output_usdc_vaults():
	vaults = get_pickle(VAULT_OBJ_FILENAME)
	actual_owners = get_pickle(ACTUAL_OWNERS_OBJ_FILENAME)
	urn_to_id_dict = get_pickle(URN_TO_ID_DICT_FILENAME)
	
	with open ('pax_vaults.csv', 'w') as myf:
		wr = csv.writer(myf)
		wr.writerow(["vaultid", "owner", "usdcLocked", "daiMinted", "daiRepaid", "currentDebt", "ratio"],)
		for i in vaults:
			usdc_locked = 0
			dai_minted = 0
			dai_repaid = 0
			...
			if(i.ilk_type == 'PAXA'):
				for k in i.actions:
					if(k['action'] == 'lock'):
						usdc_locked += k['amount']
					elif(k['action'] == 'free'):
						usdc_locked -= k['amount']
					elif(k['action'] == 'draw'):
						dai_minted += (k['amount'] / ETH_SCALE) 
					elif(k['action'] == 'wipe'):
						dai_repaid += (k['amount'] / ETH_SCALE) 

				actual_owner = actual_owners[i.vaultid]
				if(i.ilk_type == ''):
					i.ilk_type = 'XXXX'
				current_debt, current_collateral = get_dnc(i.vaultid, QUICK_DICT_PATCH[i.ilk_type], i.ilk_type)

				current_ratio = 0
				if (current_debt > 0.00001):
					ilk_price = 1
					current_ratio = current_collateral * ilk_price / current_debt
					print(current_ratio)
				roww = [i.vaultid, actual_owner, current_collateral, dai_minted, dai_repaid, current_debt, current_ratio]
				wr.writerow(roww)


def auto_update_all():
	noww = datetime.datetime.now()
	newfi = "vaultfarmers" + str(noww.year) + str(noww.month) + str(noww.day) + "owner.csv"

	prev_block_updated = get_prev_b()
	going_to_block = web3.eth.blockNumber - (web3.eth.blockNumber % 100)
	update_vault_id(prev_block_updated, going_to_block , True, STEP_SIZE)
	update_actual_owners()
	get_all_owner_strategy()
	output_farming_csv_new(STRAT_OBJ_FILENAME, newfi)
...
def send_html(newfi):
	...
	ssh.connect(hostname=web_url, username='root', password=ssh_key )
	...
	try:
		scp.put('/home/jix/sketchbook/getvaults/{0}'.format(newfi), remote_path='/var/www/html')
		scp.put('/home/jix/sketchbook/getvaults/index.html', remote_path='/var/www/html')
	except:
		print("failed to send new stuff to vps")
...
def save_html(new_name):
	# get the old list
	fils = get_files_i_care_about()
	
	fils.append(new_name)
	print(fils)
	# save the new list of files 
	with open(FILES_I_CARE_ABOUT_CSV, 'w') as myf:
		wr = csv.writer(myf)
		for i in fils:
			wr.writerow([i])

	# build the html off of the file list
	buld1 = """<!DOCTYPE html>
	<html>
	<body>

	<p>Selected farming activity of all active and 0 debt vault owners. Updated ~7am UTC</p>

	"""
	pat = "/var/www/html/"
	buld2 = ''
	for i in range(len(fils) - 1, -1, -1):
		bb = "<a href={0} download>{0}</a><br>\n".format(fils[i])
		buld2 = buld2 + bb
	...
	"""
	final_buld = buld1 + buld2 + buld3
	

	ff = open('index.html','w')
	ff.write(final_buld)
	ff.close()
...
def main():
	...
	parser.add_argument('--outputfarmingcsvold', action='store_true', dest='outputfarmingcsvold', help='writes the farming strategies correlations to csv')
	parser.add_argument('--outputfarmingcsvnew', action='store_true', dest='outputfarmingcsvnew', help='writes the farming strategies correlations to csv the new way')
	parser.add_argument('--outputusdcvaults', action='store_true', dest='outputusdcvaults', help='writes the usdc vaults and debt to a csv')
	parser.add_argument('--autoupdateall', action='store_true', dest='autoupdateall', help='updates everything')
	...
	if argss.updatevaultid:
		...
		update_vault_id(11049900, 11068000 , True, STEP_SIZE)
		sys.exit(0)	
	...
	if argss.getinterestingownerstrategy:
		...
		sys.exit(0)
	if argss.outputfarmingcsvold:
		#strat_file = STRAT_INTERESTING_OBJ_FILENAME
		strat_file = STRAT_OBJ_FILENAME
		output_farming_csv_old(strat_file)
		sys.exit(0)
	if argss.outputfarmingcsvnew:
		#strat_file = STRAT_INTERESTING_OBJ_FILENAME
		strat_file = STRAT_OBJ_FILENAME
		output_farming_csv_new(strat_file)
		sys.exit(0)

	if argss.outputusdcvaults:
		output_usdc_vaults()
		sys.exit(0)
	if argss.autoupdateall:
		auto_update_all()
		sys.exit(0)
